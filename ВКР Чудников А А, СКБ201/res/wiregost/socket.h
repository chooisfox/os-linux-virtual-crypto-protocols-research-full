...
int wg_socket_send_buffer_as_reply_to_skb(struct wg_device *wg, struct sk_buff *in_skb, void *out_buffer, size_t len);
...
#define net_dbg_skb_ratelimited(fmt, dev, skb, ...)                                                                                                \
	do {                                                                                                                                           \

...
enum noise_lengths {
	NOISE_PUBLIC_KEY_LEN = GOST_EC256_PUB_LEN,
	NOISE_SYMMETRIC_KEY_LEN = KUZNYECHIK_KEY_SIZE,
	NOISE_TIMESTAMP_LEN = sizeof(u64) + sizeof(u32),
	NOISE_AUTHTAG_LEN = KUZNYECHIK_MGM_TAG_SIZE,
	NOISE_HASH_LEN = STREEBOG256_DIGEST_SIZE
};

#define noise_encrypted_len(plain_len) ((plain_len) + NOISE_AUTHTAG_LEN)

enum cookie_values { COOKIE_SECRET_MAX_AGE = 2 * 60, COOKIE_SECRET_LATENCY = 5, COOKIE_NONCE_LEN = 16, COOKIE_LEN = 16 };
...
enum message_alignments {
	MESSAGE_PADDING_MULTIPLE = 16, /* Kuznyechik block size is 16 */
